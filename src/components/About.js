                            ...
                            <Container>
                                <Row className="align-items-center">
                                    <Col xs={12} md={8} xl={8} className="pr-5 square">
                                        <h2>About</h2>
                                        <p>Hi, I'm a college student who likes problem-solving. From analyzing companies and industries, to running my <a target="_blank" href="https://www.vo2.fans/">own startup</a>, to running data and statistical analyses,
